...
<body>
    <div class="background">
        <div class="container">
            ...
            <form id="employee-form" action="BancoCliente.php" method="post">
                ...
                <div class="input-group name-birth">
                    ...
                    <div class="birth-group">
                        ...
                        <input type="text" id="CPF" name="CPF" placeholder="Digite o Email">
                    </div>
    ...
    <script>
        ...
        function cancelConfirmation(confirmed) {
            if (confirmed) {
                ...
                window.location.href = "../Cliente/DadosC.php"; // Substitua pelo link da outra página
            } else {
